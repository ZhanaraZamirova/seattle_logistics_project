...
**Tools Used:** Python (Pandas, Datetime), SQL (SQLite), Tableau, and VS Code.
...
4. **Load:** Finally, I pushed the transformed dataset into a local SQLite database to simulate a standard data warehousing environment.
